...
{
    public class MutableHijackIndexDocumentFacts
    {
        public class Solidify
        {
            ...
            {
                var output = new MutableHijackIndexDocument().Solidify();
            ...
            {
                var output = new MutableHijackIndexDocument(
                    delete: true,
        ...
        public class ApplyChange
        {
            ...
            {
                var doc = new MutableHijackIndexDocument();
